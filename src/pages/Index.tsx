        ...
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center md:items-start px-8 md:px-12">
          ...
          >
            ...
            <h1 className="font-poppins font-semibold mb-4 md:mb-6 we-gradient-text animate-fade-in drop-shadow-2xl text-left w-full leading-none space-y-2" style={{ color: '#ffffff' }}>
              <span className="block text-[43px] md:text-[72px] leading-none">Transform</span>
              <span className="block text-[43px] md:text-[72px] leading-none">your online</span>
              ...
              <span className="flex items-center text-[43px] md:text-[72px] leading-none gap-2">
                ...
                <Logo className="w-[200px] md:w-[270px] h-auto" />
              </span>
            </h1>
            ...
            <div className={`flex items-center gap-4 mt-8 mb-8 transition-all duration-700 ${heroActionsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <a href="https://whatsapp.com/channel/0029Vb9lC6kA89MdSFyb4x3l" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-black transition-colors duration-200 hover:bg-gray-800 shadow-lg hover:shadow-xl">
                <img src="/lovable-uploads/icons8-whatsapp.svg" alt="WhatsApp" className="w-6 h-6 invert" />
              </a>
              <a href="https://www.instagram.com/wedessign?igsh=MzBsdTNwZTg2cGxr" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-black transition-colors duration-200 hover:bg-gray-800 shadow-lg hover:shadow-xl">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
              ...
              <div
                ...
                className={`transition-all duration-700 ${serviceCardsVisible[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} bg-[#181028] rounded-3xl py-6 px-6 md:px-8 min-h-[280px] md:min-h-[320px] max-w-sm w-full flex flex-col items-start shadow-lg hover:bg-gradient-to-tr hover:from-[#9333ea] hover:to-[#2d145e]`}
              >
              ...
              <div
                ...
                className={`transition-all duration-700 ${serviceCardsVisible[1] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} bg-[#181028] rounded-3xl py-6 px-8 min-h-[320px] max-w-sm w-full flex flex-col items-start shadow-lg hover:bg-gradient-to-tr hover:from-[#9333ea] hover:to-[#2d145e]`}
              >
              ...
              <div
                ...
                className={`transition-all duration-700 ${serviceCardsVisible[2] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} bg-[#181028] rounded-3xl py-6 px-8 min-h-[320px] max-w-sm w-full flex flex-col items-start shadow-lg hover:bg-gradient-to-tr hover:from-[#9333ea] hover:to-[#2d145e]`}
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 custom-cursor-stacks">
              {stacks.map((stack, i) => (
                <div
                  ...
                  className={`transition-all duration-700 ${stackVisible[i] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} bg-[#181028] rounded-3xl flex flex-col items-center justify-center py-10 px-4 shadow-lg hover:bg-gradient-to-tr hover:from-[#9333ea] hover:to-[#2d145e]`}
                >
        ...
        <section id="projects" className="py-14 md:py-36 pb-48 w-screen relative left-1/2 right-1/2 -mx-[50vw] -mt-16 bg-gradient-to-br from-[#6506a2] to-[#1955d9] flex justify-center items-center">
          <div className="w-full">
            <h2 
              ...
              className={`text-4xl md:text-5xl font-poppins font-semibold text-center mb-28 md:mb-32 we-gradient-text text-white transition-all duration-700 ${
