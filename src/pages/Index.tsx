          ...
          >
            ...
            <h1 className="font-poppins font-semibold mb-4 md:mb-6 we-gradient-text animate-fade-in drop-shadow-2xl text-left w-full leading-none" style={{ color: '#f4f4f2' }}>
              ...
              <span className="flex items-baseline text-[52px] md:text-[72px] leading-none">
                with
                <Logo className="w-[190px] md:w-[200px] h-auto ml-2" />
              </span>
            </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
              ...
              <div
                ...
                className={`transition-colors duration-500 transition-all duration-700 ${serviceCardsVisible[1] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} bg-[#181028] rounded-3xl py-6 px-8 min-h-[320px] max-w-sm w-full flex flex-col items-start shadow-lg hover:bg-gradient-to-tr hover:from-[#9333ea] hover:to-[#2d145e]`}
              >
              ...
              <div
                ...
                className={`transition-colors duration-500 transition-all duration-700 ${serviceCardsVisible[2] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} bg-[#181028] rounded-3xl py-6 px-8 min-h-[320px] max-w-sm w-full flex flex-col items-start shadow-lg hover:bg-gradient-to-tr hover:from-[#9333ea] hover:to-[#2d145e]`}
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 custom-cursor-stacks">
              {stacks.map((stack, i) => (
                <div
                  ...
                  className={`transition-colors duration-500 ${stackVisible[i] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} transition-all duration-700 bg-[#181028] rounded-3xl flex flex-col items-center justify-center py-10 px-4 shadow-lg hover:bg-gradient-to-tr hover:from-[#9333ea] hover:to-[#2d145e]`}
                >
          ...
          <div className="w-full">
            ...
            <div className="max-w-6xl w-full mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-16 md:gap-8 px-4 md:px-0">
              <div
                ...
                className={`transition-colors duration-500 transition-all duration-700 ${projectCardsVisible[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
              >
                <ProjectCard
              ...
              <div
                ...
                className={`transition-colors duration-500 transition-all duration-700 ${projectCardsVisible[1] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
              >
                <ProjectCard
                  title="Nutrichef AI"
              ...
              <div
                ...
                className={`transition-colors duration-500 transition-all duration-700 ${projectCardsVisible[2] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
              >
                <ProjectCard
