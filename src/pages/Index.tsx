        ...
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center md:items-start px-4 md:px-12">
          ...
          >
            ...
            <div className={`flex items-center gap-4 mt-8 mb-8 transition-all duration-700 ${heroActionsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <a href="https://whatsapp.com/channel/0029Vb9lC6kA89MdSFyb4x3l" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-8 h-8 rounded-full bg-black transition-colors duration-200 hover:bg-gray-800 shadow-lg hover:shadow-xl">
                <img src="/lovable-uploads/icons8-whatsapp.svg" alt="WhatsApp" className="w-6 h-6 invert" />
              </a>
              <a href="https://www.instagram.com/wedessign?igsh=MzBsdTNwZTg2cGxr" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-8 h-8 rounded-full bg-black transition-colors duration-200 hover:bg-gray-800 shadow-lg hover:shadow-xl">
